module.exports = class Data1663594336146 {
  name = 'Data1663594336146'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "erc1155_contract" ("id" character varying NOT NULL, "name" text, "symbol" text, "total_supply" numeric, "contract_uri" text, "contract_uri_updated" numeric, "decimals" integer, "address" text, "start_block" integer NOT NULL, "metadata_name" text, "description" text, "image" text, "external_link" text, "artist" text, "artist_url" text, CONSTRAINT "PK_714a9ea4826d73898b5c2251116" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "erc1155_token" ("id" character varying NOT NULL, "numeric_id" numeric NOT NULL, "token_uri" text, "updated_at" numeric NOT NULL, "created_at" numeric NOT NULL, "contract_id" character varying NOT NULL, "total_supply" numeric, "metadata_id" character varying, CONSTRAINT "PK_63124737654b07d068bf54cfcfe" PRIMARY KEY ("id"))`)

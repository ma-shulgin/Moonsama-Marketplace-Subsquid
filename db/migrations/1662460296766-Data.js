module.exports = class Data1662460296766 {
  name = 'Data1662460296766'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "erc1155_token_owner" ("id" character varying NOT NULL, "balance" numeric NOT NULL, "owner_id" character varying, "token_id" character varying, CONSTRAINT "PK_f8b449f74ab74862ce3d754a0c9" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "erc721_transfer" ("id" character varying NOT NULL, "timestamp" numeric NOT NULL, "block" integer NOT NULL, "transaction_hash" text NOT NULL, "token_id" character varying, "from_id" character varying, "to_id" character varying, CONSTRAINT "PK_972b8de69f0dc0e83d55d39c2f5" PRIMARY KEY ("id"))`)
